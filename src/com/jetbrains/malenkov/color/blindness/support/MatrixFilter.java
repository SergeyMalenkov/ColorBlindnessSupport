...
final class MatrixFilter extends RGBImageFilter {
    ...
    public static ImageFilter forProtanopia(Double weight) {
        return new MatrixFilter("Protanopia (correction matrix)", new OldMatrixConverter(weight, ColorBlindnessMatrix.Protanopia.MATRIX));
    }

    public static ImageFilter forDeuteranopia(Double weight) {
        return new MatrixFilter("Deuteranopia (correction matrix)", new OldMatrixConverter(weight, ColorBlindnessMatrix.Deuteranopia.MATRIX));
    }

    public static ImageFilter forTritanopia(Double weight) {
        return new MatrixFilter("Tritanopia (correction matrix)", new OldMatrixConverter(weight, ColorBlindnessMatrix.Tritanopia.MATRIX));
    }
